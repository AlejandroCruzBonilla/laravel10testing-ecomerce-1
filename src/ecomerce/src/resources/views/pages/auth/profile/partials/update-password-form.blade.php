<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-forms.text-input id="current_password" name="current_password" type="password" class="block w-full"
        ...
        <div>
            ...
            <x-forms.text-input id="password" name="password" type="password" class="block w-full"
